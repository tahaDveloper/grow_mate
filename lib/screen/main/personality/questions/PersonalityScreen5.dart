...
class PersonalityScreen5 extends StatelessWidget {
  const PersonalityScreen5({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:
            Text("تحلیل شخصیت", style: GoogleFonts.roboto(color: Colors.white)),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "سوال ۵: سبک کاری شما چطوره؟",
              style: GoogleFonts.roboto(fontSize: 18, color: Colors.white),
            ),
            const SizedBox(height: 20),
            ...List.generate(controller.options5.length, (index) {
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                              child: Text(controller.options5[index],
                                  style:
