...
class PersonalityScreen2 extends StatelessWidget {
  const PersonalityScreen2({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "سوال ۲: سبک زندگی شما چطوره؟",
              style: GoogleFonts.roboto(fontSize: 18, color: Colors.white),
            ),
            const SizedBox(height: 20),
            ...List.generate(controller.options2.length, (index) {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: Text(controller.options2[index], style: GoogleFonts.roboto(color: Colors.white))),
                    ],
                  ),
                ),
              ));
            ...
            Center(
              child: Obx(() => ElevatedButton(
                onPressed: selectedOption.value != -1
                  ...
                  Get.toNamed("PersonalityScreen3");
                }
                    : null,
