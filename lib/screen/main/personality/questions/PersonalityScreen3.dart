...
class PersonalityScreen3 extends StatelessWidget {
  const PersonalityScreen3({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "سوال ۳: سبک تصمیم‌گیری شما چطوره؟",
              style: GoogleFonts.roboto(fontSize: 18, color: Colors.white),
            ),
            const SizedBox(height: 20),
            ...List.generate(controller.options3.length, (index) {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(child: Text(controller.options3[index], style: GoogleFonts.roboto(color: Colors.white))),
                    ],
                  ),
                ),
              ));
            ...
            Center(
              child: Obx(() => ElevatedButton(
                ...
                Get.toNamed("PersonalityScreen4");
                }
                    : null,
